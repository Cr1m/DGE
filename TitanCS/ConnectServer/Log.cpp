...
{	
	...
	//wsprintf(szTemp,"Logs\\%02d%02d%02d_%s.log",LogMYear, LogMonth, LogMDay,"Titan_ConnectServer");
	wsprintf(szTemp,"Logs\\%s_%02d%02d%02d.log","ConnectServer",LogMYear, LogMonth, LogMDay);
